...
@Repository
public class LtDnAreaMeasureDaoImpl extends BaseDaoImpl<LtDnAreaMeasure, Integer>
		implements LtDnAreaMeasureDao {

	@Override
	public List getWebList(Pager pager, Map<String, String> searchProperties) {
		String sql = "select * from Lt_DnAreaMeasure";
		String sqlCount = "select count(*) from Lt_DnAreaMeasure m ";
		...
		return getSession().createSQLQuery(sql).addEntity(LtDnAreaMeasure.class).list();
	}

	@Override
	public LtDnAreaMeasure getWebEntity(Integer id) {
		return get(id);
	}
	...
	public void deleteWebIds(String ids) {
		if (StringUtils.isNotEmpty(ids)) {
			...
			getSession().createSQLQuery("delete from Lt_DnAreaMeasure where id in(:ids)")
			.setParameterList("ids", idArr).executeUpdate();
		}
	}

	@Override
	public Integer saveOrUpdateWebEntity(LtDnAreaMeasure entity) throws Exception {
	...
	@Override
	public LtDnAreaMeasure getShopEntity(Integer id) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Integer saveOrUpdateShopEntity(LtDnAreaMeasure entity) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
