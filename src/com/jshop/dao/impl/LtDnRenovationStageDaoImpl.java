...
@Repository
public class LtDnRenovationStageDaoImpl extends BaseDaoImpl<LtDnRenovationStage, Integer>
		implements LtDnRenovationStageDao {

	@Override
	public List getWebList(Pager pager, Map<String, String> searchProperties) {
		String sql = "select * from Lt_DnRenovationStage";
		String sqlCount = "select count(*) from Lt_DnRenovationStage m ";
		...
		return getSession().createSQLQuery(sql).addEntity(LtDnRenovationStage.class).list();
	}

	@Override
	public LtDnRenovationStage getWebEntity(Integer id) {
		return get(id);
	}
	...
	public void deleteWebIds(String ids) {
		if (StringUtils.isNotEmpty(ids)) {
			...
			getSession().createSQLQuery("delete from Lt_DnRenovationStage where id in(:ids)")
			.setParameterList("ids", idArr).executeUpdate();
		}
	}

	@Override
	public Integer saveOrUpdateWebEntity(LtDnRenovationStage entity) throws Exception {
	...
	@Override
	public LtDnRenovationStage getShopEntity(Integer id) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Integer saveOrUpdateShopEntity(LtDnRenovationStage entity) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
