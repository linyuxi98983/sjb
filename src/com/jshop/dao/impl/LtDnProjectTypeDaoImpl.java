...
@Repository
public class LtDnProjectTypeDaoImpl extends BaseDaoImpl<LtDnProjectType, Integer>
		implements LtDnProjectTypeDao {

	@Override
	public List getWebList(Pager pager, Map<String, String> searchProperties) {
		String sql = "select * from Lt_DnProjectType";
		String sqlCount = "select count(*) from Lt_DnProjectType m ";
		...
		return getSession().createSQLQuery(sql).addEntity(LtDnProjectType.class).list();
	}

	@Override
	public LtDnProjectType getWebEntity(Integer id) {
		return get(id);
	}
	...
	public void deleteWebIds(String ids) {
		if (StringUtils.isNotEmpty(ids)) {
			...
			getSession().createSQLQuery("delete from Lt_DnProjectType where id in(:ids)")
			.setParameterList("ids", idArr).executeUpdate();
		}
	}

	@Override
	public Integer saveOrUpdateWebEntity(LtDnProjectType entity) throws Exception {
	...
	@Override
	public LtDnProjectType getShopEntity(Integer id) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Integer saveOrUpdateShopEntity(LtDnProjectType entity) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
