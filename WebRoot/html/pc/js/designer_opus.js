...
define(function(require, exports, module) {
    ...
    require('http://www.to8to.com/gb_js/jq.uploadify.min.js?1');
    require('colorbox');
    ...
    var blogForm = {
        offsetTop : $('#blogForm').length < 1 ? false : $('#blogForm').offset().top ,
        init : function(){
            var _this = this;
            _this.submitForm();
            _this.setPosition();
        ...
        submitForm : function(){
            $('#blogForm #blogBtn').live('click',function() {
                SJB.postFrom($(this),115);
                return false;
            }) 
        },
        setPosition : function(){
            ...
            if(scrollTop > _this.offsetTop){
                $('#blogForm').css({'position':'fixed','top':'0','right':(winWidth - 990)/2});    
            } 
            else{
                $('#blogForm').css({'position':'absolute','top':'368px','right':'0'});
            }
        }    
    }
        ...
        $('.popup_upload_head .btn_upload').live('click',function(){
            ...
            var uploadStr = '<div class="upload_img">\
                        ...
                        <div class="upload_img_main">\
                            ...
                            <p class="prompt">\
                                <span>温馨提示</span>\
                                <span class="prompt_con">◇ 只有合作设计师才能自定义背景，合作请联系4006-808-509转8888。</span>\
