...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 添加系统管理员账号
	</div>
	<form id="inputForm" action="web/operator/operator!save.action" method="post" novalidate="novalidate">
		...
		<table class="input tabContent" style="display: table;">
			...
			<tr>
				...
				<td>
					<input type="text" name="entity.loginName" class="text" >
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="password" name="entity.password" class="text" >
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="entity.name" class="text" >
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="entity.department" class="text" >
				</td>
			</tr>
			<tr>
				<th>
