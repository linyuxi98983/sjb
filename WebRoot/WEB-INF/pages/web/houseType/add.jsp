...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 添加地段
	</div>
	<form id="inputForm" action="web/houseType/houseType!save.action" method="post" enctype="multipart/form-data" novalidate="novalidate">
		<ul id="tab" class="tab">
			<li>
				<input type="button" value="地段信息" class="current">
			</li>
		</ul>
