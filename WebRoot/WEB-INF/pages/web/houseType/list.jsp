...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 地段列表 <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/houseType/houseType!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/houseType/houseType!add.action" class="iconButton">
			...
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/houseType/houseType!delete.action">
		...
		<table id="listTable" class="list">
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<a href="web/houseType/houseType!edit.action?id=<s:property value="id"/>">[编辑]</a>
