...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 部门列表 <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/department/department!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/department/department!add.action" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/department/department!delete.action">
		...
		<table id="listTable" class="list">
			<tbody><tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="lCode">层级码</a>
				</th>
				<th>
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<s:property value="lCode" />
					</td>
					<td>
						<s:property value="closed" />
					</td>
					<td>
						<s:if test='closed == 0'>
							运行中
					...
					<td>
						<a href="web/department/department!edit.action?id=<s:property value="id"/>">[编辑]</a>
						<s:if test='closed == 0'>
							<a href="#" onclick="updateField('department',{'entity.id':<s:property value="id"/>,'entity.closed':1}); return false;">[冻结]</a>
						</s:if>
						<s:else>
							<a href="#" onclick="updateField('department',{'entity.id':<s:property value="id"/>,'entity.closed':0}); return false;">[解冻]</a>
						</s:else>
					</td>
				</tr>
				</s:iterator>
