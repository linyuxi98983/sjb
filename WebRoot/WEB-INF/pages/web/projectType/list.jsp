...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 需求风格列表 <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/projectType/projectType!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/projectType/projectType!add.action" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/projectType/projectType!delete.action">
		...
		<table id="listTable" class="list">
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<a href="web/projectType/projectType!edit.action?id=<s:property value="id"/>">[编辑]</a>
