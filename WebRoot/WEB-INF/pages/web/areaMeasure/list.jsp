...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 项目面积列表 <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/areaMeasure/areaMeasure!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/areaMeasure/areaMeasure!add.action" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/areaMeasure/areaMeasure!delete.action">
		...
		<table id="listTable" class="list">
			<tbody><tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="minSqm">面积最小值</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="maxSqm">面积最大值</a>
				</th>
				<th>
					<span>操作</span>
				</th>
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<s:property value="minSqm" />
					</td>
					<td>
						<s:property value="maxSqm" />
					</td>
					<td>
						<a href="web/areaMeasure/areaMeasure!edit.action?id=<s:property value="id"/>">[编辑]</a>
