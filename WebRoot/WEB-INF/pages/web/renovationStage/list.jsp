...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 装修阶段列表 <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/renovationStage/renovationStage!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/renovationStage/renovationStage!add.action" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/renovationStage/renovationStage!delete.action">
		...
		<table id="listTable" class="list">
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<a href="web/renovationStage/renovationStage!edit.action?id=<s:property value="id"/>">[编辑]</a>
						<a href="web/renovationStage/renovationStage!delete.action?ids=<s:property value="id"/>">[删除]</a>
					</td>
				</tr>
				</s:iterator>
		</tbody></table>
