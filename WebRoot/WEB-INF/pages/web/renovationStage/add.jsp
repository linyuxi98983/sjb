...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>装修阶段类型添加</title>
    <%@ include file="/WEB-INF/pages/web/common/public.jsp" %>
  </head>
  
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 添加装修阶段类型
	</div>
	<form id="inputForm" action="web/renovationStage/renovationStage!save.action" method="post" enctype="multipart/form-data" novalidate="novalidate">
		<ul id="tab" class="tab">
			<li>
				<input type="button" value="装修阶段类型信息" class="current">
			</li>
		</ul>
