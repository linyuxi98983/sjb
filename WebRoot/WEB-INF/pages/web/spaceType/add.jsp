...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 添加电竞风格
	</div>
	<form id="inputForm" action="web/spaceType/spaceType!save.action" method="post" enctype="multipart/form-data" novalidate="novalidate">
		<ul id="tab" class="tab">
			<li>
				<input type="button" value="电竞风格信息" class="current">
			</li>
		</ul>
