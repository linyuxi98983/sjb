...
<body>
	...
	<form id="listForm" action="web/mb/mb!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/mb/mb!add.action" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/mb/mb!delete.action">
		...
		<table id="listTable" class="list">
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<a href="web/mb/mb!edit.action?id=<s:property value="id"/>">[编辑]</a>
						<s:if test='closed == 0'>
