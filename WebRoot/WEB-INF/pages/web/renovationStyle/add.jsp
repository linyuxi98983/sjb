...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>装修网咖风格添加</title>
    <%@ include file="/WEB-INF/pages/web/common/public.jsp" %>
  </head>
  
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 添加装修网咖风格
	</div>
	<form id="inputForm" action="web/renovationStyle/renovationStyle!save.action" method="post" enctype="multipart/form-data" novalidate="novalidate">
		<ul id="tab" class="tab">
			<li>
				<input type="button" value="装修网咖风格信息" class="current">
			</li>
		</ul>
