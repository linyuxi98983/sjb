...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 装修网咖风格列表 <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/renovationStyle/renovationStyle!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/renovationStyle/renovationStyle!add.action" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/renovationStyle/renovationStyle!delete.action">
		...
		<table id="listTable" class="list">
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<a href="web/renovationStyle/renovationStyle!edit.action?id=<s:property value="id"/>">[编辑]</a>
						<a href="web/renovationStyle/renovationStyle!delete.action?ids=<s:property value="id"/>">[删除]</a>
					</td>
				</tr>
				</s:iterator>
		</tbody></table>
