...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 编辑设计
	</div>
	<form id="inputForm" action="web/budget/budget!save.action" method="post" enctype="multipart/form-data" novalidate="novalidate">
		...
		<table class="input tabContent" style="display: table;">
			...
			<tr>
				...
				<td>
					<input type="minAmt" name="entity.minAmt" class="text"  value="<s:property value="entity.minAmt"/>">
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="maxAmt" name="entity.maxAmt" class="text"  value="<s:property value="entity.maxAmt"/>">
				</td>
			</tr>
			<tr>
				<th>
