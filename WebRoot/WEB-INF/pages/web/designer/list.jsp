...
<body>
	<div class="path">
		<a href="web/common/main.action">首页</a> » 设计师列表 <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/designer/designer!list.action" method="post">
		<div class="search">
			<table>
				<tr>
					<th>
		...
		<div class="bar">
			<a href="web/designer/designer!add.action" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" url="web/designer/designer!delete.action">
		...
		<table id="listTable" class="list">
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<a href="web/designer/designer!edit.action?id=<s:property value="id"/>">[编辑]</a>
						<s:if test='closed == 0'>
							<a href="#" onclick="updateField('designer',{'entity.id':<s:property value="id"/>,'entity.closed':1}); return false;">[冻结]</a>
						</s:if>
						<s:else>
							<a href="#" onclick="updateField('designer',{'entity.id':<s:property value="id"/>,'entity.closed':0}); return false;">[解冻]</a>
						</s:else>
					</td>
				</tr>
				</s:iterator>
