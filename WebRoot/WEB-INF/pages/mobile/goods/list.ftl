    ...
    <body>
        ...
        <section class="_pre">
           ...
           <header id="head_search_box" dd_name="结果页头部">
                <div class="search_header">
                   ...
                   <a id="goods_list_type" class="goods_list_single"></a>
                </div>
            </header>
            ...
            <section class="filtrate_term" id="product_sort" dd_name="商品排序">
                <ul>
                    ...
                    <li class=""><a name="list_sort_score">评分</a></li>
                    <li class="">
            ...
            <!-- 加载更多 -->
            <input type="hidden" id="curr_page" value="1"></input>
            ...
            <header id="bd">
                <header class="con floatsearch">
                    ...
                    <section class="mix_new_header">
                        ...
                        <form id="index_search_form" method="post" action="goods!list.action" target="_parent"
                        onsubmit="return mix_submit_search();">
                            <div class="search">
                                ...
                                <a href="javascript:void(0)" class="clear_input" id="clear_input" style="display: block;">
                                </a>
                                <input type="hidden" id="return_result" name="result" value=""/>
                                <input type="hidden" id="typeId_ipt" name="type"/>
                            </div>
       ...
       <input type="hidden" id="total_page" value="${pager.pageCount!}"/>
        ...
        <script>
        	...
        	if(pageCount == 0){
	    		$(".goods_list").append("<div id='nodata_css' stype='text-align: center'>无数据</div>");
