	...
	<div class="descon">
		<ul>
			<#if list ??>
				...
				<li>
				<p class="ptitle"><span class="pspan"></span><label><strong><a href="${base}/pc/dinfo/dinfo!detail.action?id=${vo.id}">${vo.title!}</a></strong></label></p>
				<p class="dmsg">${vo.preview!}</p>
				</li>
				</#list>
			<#else>
				<li>
					<p class="ptitle"><span class="pspan">没有相关资讯</span></p>
				</li>
			</#if>
