...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript">
    	$(function(){
    		var member="";
    		jq("#sjs_case_r_r").on("click",function(){
    			var member = '<#if entity.mb.memberType==1>设计师<#else>设计机构</#if>';
    			jq("#sjs_case_r_r").on("click",function(){
    			var content = "<div><span>" +"昵称:${entity.mb.nickname}</div><div></span><span>电话:${entity.mb.phoneNo!}</span></div><div>设计经验${entity.mb.designExperience!}</div><div>擅长:${entity.mb.goodsAtSpace!}</div><div>个人说明：${entity.mb.description!}</div>";
    			layer.open({
				    type: 1,
    		...
    		jq("#sjs_case_r").on("click",function(){
  ...
  <body>
      ...
      <div class="content_width ">
          ...
          <div class="caseDetail">
            ...
            <div class="imgContent" id="imgContent">
              ...
              <#if entity.picList? exists>
                ...
                <div class="wraps">
                  <div class="case_btn">
                    <span class="add addQuestion-detail outmouse me_btn new-bg" data-src="${image.imagePath!}"
                    data-id="2221417">
                      <em></em>
                      <a onclick="askQuestion(${image.id})">提问</a>
                    </span>
                    <span class="add addCollection-detail cols new-bg" data-id="2221417" data-src="${image.imagePath!}">
                      <em></em>
                      <a onclick="favoriteFun(${image.id})">收藏</a>
                    </span>
                  </div>
                  <div class="case_title">
                    <a href="" target="_blank">${entity.title!}</a>
                  </div>
                </div>
                <div>
              ...
              <!--    浓烈的色彩加上怀旧的复古感，造就了这个具有浓厚艺术气息的书房。在美式情调的空间里，继续品味关于家美好的故事……-->
                </div>
              </div>     	
        ...
        <div class="authorInfo_new_outside">
          <div class="authorInfo_new">
            ...
            <a class="btn reservation" id="sjs_case_r_r" href="javascript:void(0)" data-id="2090485">
             	获取<#if entity.mb.memberType==1>设计师<#else>设计机构：</#if>信息
            </a>
            <a class="btn reservation" id="sjs_case_r" href="javascript:void(0)" data-id="2090485" style="margin-top:20px;">
             	预约咨询
            </a>
    ...
    <div class="none_f" id="goTop" style="display: none;">
