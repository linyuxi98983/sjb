               ...
               <#if list ??>         
	               <div class="list_info">      
		               <#list list as demand>
			                <div class="_info">
			                  <div>
			                    <a href="${base}/pc/demand/demand!detail.action?id=${demand.id}" target="_blank">${demand.title!}</a>
			                    <span class="price">${demand.budgetName!}元</span>
			                  </div>
			                  <div class="jc_info">
			                    <span style="padding-left:0;">${demand.areaZone!}</span>
			                    <span>${demand.projectType!}</span>
			                    <span>${demand.areaSqm}m²</span>
			                    <span style="border-right:none;">${demand.publicDate!}</span>
			                  </div>
			                
			                <div class="btne apply_index">
			                  <a href="${base}/pc/demand/demand!detail.action?id=${demand.id}" class="btn_unclick" target="_blank">查看详情</a>
			                </div>
			                </div>
		               </#list>
	               </div>
                ...
                <div class="page">
          <div class="page_num" style="margin-top:300px;">
          		<@page pager base + "/pc/designer/designer!home.action"/>
