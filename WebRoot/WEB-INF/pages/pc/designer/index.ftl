    ...
    <div class="content_width">
      <div class="content_width ">
        ...
        <div class="column_left">
          ...
          <div class="fiterbox">
            <div class="fiterList">
              <div class="fiterLine">
                ...
                <div class="selectLsist">
                  <a rel="nofollow" href="" class="onselect">
                    <span>不限</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=北京" class="">
                    <span>北京</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=上海" class="">
                    <span>上海</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=广州" class="">
                    <span>广州</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=深圳" class="">
                    <span>深圳</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=南京" class="">
                    <span>南京</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=天津" class="">
                    <span>天津</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=杭州" class="">
                    <span>杭州</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=武汉" class="">
                    <span>武汉</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=成都" class="">
                    <span>成都</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=西安" class="">
                    <span>西安</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=福州" class="">
                    <span>福州</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=苏州" class="">
                    <span>苏州</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=郑州" class="">
                    <span>郑州</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=合肥" class="">
                    <span>合肥</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=贵阳" class="">
                    <span>贵阳</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=宁波" class="">
                    <span>宁波</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?searchByArea=长沙" class="">
                    <span>长沙</span>
                  </a>
                  <a href="javascript:;" class="more_cities">
                    <span>[其他城市]</span>
                  </a>
                </div>
              </div>
              <div class="fiterLine">
                <span class="title">擅长空间：</span>
                <div class="selectLsist">
                  <a rel="nofollow" href="" class="onselect">
                    <span>不限</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=家居住宅" class="">
                    <span>家居住宅</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=别墅豪宅" class="">
                    <span>别墅豪宅</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=办公室" class="">
                    <span>办公室</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=酒店" class="">
                    <span>酒店</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=餐厅" class="">
                    <span>餐厅</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=咖啡厅" class="">
                    <span>咖啡厅</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=酒店KTV" class="">
                    <span>酒吧KTV</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=商业展示" class="">
                    <span>商业展示</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=医院" class="">
                    <span>医院</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=幼儿园" class="">
                    <span>幼儿园</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=会所" class="">
                    <span>会所</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=样板房" class="">
                    <span>样板房</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=售楼处" class="">
                    <span>售楼处</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=文化空间" class="">
                    <span>文化空间</span>
                  </a>
                  <a href="${base}/pc/designer/designer!index.action?houseTypeOrSpaceType=运动空间" class="">
                    <span>运动空间</span>
                  </a>
                </div>
              </div>
              <div class="fiterLine">
                <span class="title">设计收费：</span>
                <div class="selectLsist">
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action" class="onselect">
                    <span>不限</span>
                  </a>
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action?MinDesignAmt=0&maxDesignAmt=60" class="">
                    <span>0-60元/m²</span>
                  </a>
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action?MinDesignAmt=60&maxDesignAmt=100" class="">
                    <span>60-100元/m²</span>
                  </a>
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action?MinDesignAmt=100&maxDesignAmt=150" class="">
                    <span>100-150元/m²</span>
                  </a>
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action?MinDesignAmt=150&maxDesignAmt=200" class="">
                    <span>150-200元/m²</span>
                  </a>
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action?MinDesignAmt=200&maxDesignAmt=300" class="">
                    <span>200-300元/m²</span>
                  </a>
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action?MinDesignAmt=300&maxDesignAmt=600" class="">
                    <span>300-600元/m²</span>
                  </a>
                  <a rel="nofollow" href="${base}/pc/designer/designer!index.action?MinDesignAmt=600" class="">
                    <span>600元/m²以上</span>
                  </a>
                </div>
              </div>
          ...
          <div class="order-box">
            <div class="top-page">
              <a rel="nofollow" href="" class="change-page">
                &lt;
              </a>
              <a href="javascript:vold();">
                <span class="current-page">1</span>/100
              </a>
              <a rel="nofollow" href="" class="change-page">
                &gt;
              </a>
          ...
          <div class="sjs-online">
            ...
            <div class="switch-box">
              <ul style="width: 4170px;">
				  
				  <#if indexData.memberOnline??>
				  	<#list indexData.memberOnline as member>
				  	   <li>
					    <a class="sjs-link" href="${base}/pc/designer/designer!personal.action?id=${member.id}" target="_blank">
					      <img src="${member.imagePath!}"
					      width="110" height="110" alt="${member.nickname!}"/>
					      <span>
					        ${member.nickname!}
					      </span>
					    </a>
            ...
            <div class="the-prev"></div>
            <div class="the-next"></div>
          </div>
          <!-- 大牌设计师在线 END -->
          <!-- 设计师列表 -->
          
          <#if indexData.memberList ??>
          	<#list indexData.memberList as member>
          		<div class="designer-box">
          
            <div class="designer-list">
              <div class="user-detail-box">
                <div class="user-headphoto">
                  <a href="${base}/pc/designer/designer!personal.action?id=${member.id}" target="_blank">
                    <img src="${member.imagePath!}"
                    width="118" height="118" alt="${member.nickname!}"/>
                  </a>
                </div>
                    ...
                    <p class="p-line">
                      <span class="user-position">
                        ...
                        <em>
		                  ...
		                  ${member.area.parent.name!}
		                  <a href="" target="_blank">${member.area.name!}</a></#if>
		                  </#if>
                        </em>
                      </span>
                      <span class="pic-num">
                    ...
                    <div class="user-nums">
                      <div class="num-box">
                        ...
                        <span class="high-light-num">
                          ${member.demandCount!0}
                        </span>
                      </div>
                    </div>
                  </div>
                  <!-- 左边的列表 -->
           			<div class="user-detail_right">
                        <p class="user-price"><span>${member.minDesignAmt!0}</span>元/m²</p>
                    	<div class="applyBox">
                         	<a href="javascript:;" id="${member.id}" data-id="277207" class="reservation yyzx">预约咨询</a>
                        </div>
                    </div>
              </div>
            <!-- 右边的列表 -->
            </div>
              <#if (member.worksList?size >0) >
            
                  <div class="user-image-box">
                <ul>
                  	 <#list member.worksList as work>
                  	 <li class="end">
                    <a href="" target="_blank">
                      <img src="${work.imagePath!}"
                      alt="香菲缤纷-中信森林湖_2132141" width="210" height="210"/>
                    </a>
                  </li>
                  	 </#list>
