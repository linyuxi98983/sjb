   ...
   <div id="success_msg" style="display: none;"><s:property value="msg"/></div>
                ...
                <div class="hea_top_right">
                    <ul class="tp_node">
                            ...
                            <span id="userName" class="name">
                                ...
                                <div class="caozuo" id="caozuo" style="display:none;" onmouseover="$('bg').rel=2;" onmouseout="$('bg').rel=1;">
                                    ...
                                    <ul class="cz " id="cz">
                                        ...
                                        <li>
                                            <a href="pc/mb/case/case!list.action" >我的案例</a>
                                        </li>
                                        <li>
                        ...
                        <li class="cur" style="width:92px;">
                            <a href="designer-index.html">设计师中心
                                <span class="jt"></span>
                            </a>
                ...
                <div class="menu_bar">
				    <div class="menu_list menu_list_last">
				        ...
				        <ul>
                            ...
                            <li>
                                <a href="pc/mb/apply/apply!list.action" target="_parent">我的接单申请</a>
                            </li>
                            --><li>
                                <a href="pc/mb/demand/demand!list.action?state=1" target="_parent">我收到的派单</a>
                            </li>
                            <li>
	...
	<form id="listForm" action="ds/appointment/appointment!list.action" method="post">                 
			...
			<tbody><tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="designer.nickname">预约人</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="designer.phoneNo">电话</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="appointDate">类型</a>
				</th>
				<th>
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<s:property value="designer.nickname"/>
					</td>
					<td>
						<s:property value="designer.phoneNo"/>
					</td>
					<td>
						<s:if test="designer.memberType == 1">设计师</s:if>
						<s:if test="designer.memberType == 2">设计机构</s:if>
					</td>
					<td>
...
<script type="text/javascript">
    ...
    //发布案例
    function addWorks(){
    	window.location.href="pc/mb/case/case!toAdd.action";
    }
    //读取cat
