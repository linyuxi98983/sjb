	                    	...
	                    	<div class="tcBox edit_prod_info">
	                        	<div class="qd_cont">
		                            ...
		                            <div class="btne edit_prod">
		                                ...
		                                <input type="button" class="btn_click" onclick="subPhoto(this)" value="指派"/>
		                                <input type="button" class="btn_unclick" onclick="closeColorbox()" value="删除"/>
		                            </div>
	                        	</div>
	                    	</div>
	                	</div>
	...
	<form id="listForm" action="web/designDemand/designDemand!list.action" method="post">                 
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<s:if test="state==0">
						<a href="pc/mb/demand/demand!edit.action?id=<s:property value="id"/>">[指派]</a>
						<a href="pc/mb/demand/demand!edit.action?ids=<s:property value="id"/>">[删除]</a>
					</s:if>
					</td>
				</tr>
				</s:iterator>
...
<script type="text/javascript">
    ...
    //发布案例
    function addWorks(){
    	window.location.href="pc/mb/demand/demand!add.action";
    }
    //读取cat
