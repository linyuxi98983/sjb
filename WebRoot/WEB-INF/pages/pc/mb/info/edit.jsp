                            ...
                            <span id="userName" class="name">
                                ...
                                <div class="caozuo" id="caozuo" style="display:none;" onmouseover="$('bg').rel=2;" onmouseout="$('bg').rel=1;">
                                    ...
                                    <ul class="cz " id="cz">
                                        ...
                                        <li>
                                            <a href="ds/mb/case.action" >我的案例</a>
                                        </li>
                                        <li>
        ...
        <div class="sjs_nav">
            <div class="banner_cont">
                ...
                <div class="ban_cont_right">
                    <ul>
                        <li class="cur">
                            <a href="ds/mb/index.action">个人中心</a>
                        </li>
        ...
        <div class="content_width" id="content">
            <div class="content_width ">
                ...
                <div class="content peson_product_manage">
                    ...
                    <div class="picts">
                        <form id="inputForm" action="ds/mb/info/info!save.action" method="post" enctype="multipart/form-data" novalidate="novalidate">
		...
		<table class="input tabContent" style="display: table;">
			...
			<tr>
				...
				<td>
					...
					<input type="hidden" name="entity.closed" value="0" />
				</td>
			</tr>
