	...
	<!--头部开始-->
        ...
        <div class="content_width" id="content">
            <div class="content_width ">
                ...
                <!--内容开始 -->
                <form id="inputForm" enctype="multipart/form-data" method="post" action="pc/org/case/case!save.action" class="properties">
					...
					<select class="select"  name="entity.ltDnRenovationStyleId" selectType="DESIGN_STYLE" selectvalue="<s:property value="entity.ltDnRenovationStyleId"/>"></select>
                                ...
                                <div class="prod_info">
                                    <label>面积：</label>
                                    <input type="text" placeholder="请填写项目面积" id="pro-area" maxlength="9" name="entity.sqm" value="<s:property value="entity.sqm"/>"/>
                                    <em class="_01"> m²</em>                                   
                                </div>
                                
                                <div class="prod_info">
                                    <label>造价：</label>
                                    <input type="text" placeholder="请填写项目造价（选填）" id="pro-price" maxlength="9" name="entity.costAmt" value="<s:property value="entity.costAmt"/>"/>
                                    <em class="_01">万元</em>                                  
                                </div>
                                 
                                <div class="prod_desc">
                                    <label>案例描述：</label>
                                    <textarea id="cate-des" name="entity.caseDescription"><s:property value="entity.caseDescription"/></textarea>
                                </div>
                                ...
                                <div class="btne product_btn">
                                    <input type="submit" class="btn_click" id="start_up" value="修改" />
                                </div>
                            </div>
                        </div>
