                            ...
                            <span id="userName" class="name">
                                ...
                                <div class="caozuo" id="caozuo" style="display:none;" onmouseover="$('bg').rel=2;" onmouseout="$('bg').rel=1;">
                                    ...
                                    <ul class="cz " id="cz">
                                        ...
                                        <li>
                                            <a href="designer-works.html" class="bj">我的案例</a>
                                        </li>
                                        <li>
        ...
        <div class="content_width" id="content">
            <div class="content_width ">
                ...
                <div class="menu_bar">
				    <div class="menu_list menu_list_last">
				        ...
				        <ul>
                           ...
                           <!-- <li>
                                <a href="${base}/pc/org/apply/apply!list.action" target="_parent">我的接单申请</a>
                            </li>-->
                            <li>
                ...
                <div class="content peson_product_manage">
                    ...
                    <div class="page">
	          <div class="page_num">
	          		<@page pager base + "/pc/org/case.action"/>
...
<script type="text/javascript">
    ...
    function delZP(thisObj) {
        ...
        jq.ajax({
        	...
        	data:{
        		...
        		if(data.success){
        			alert(data.msg);
        			window.location.href = "${base}/pc/ds/case.action";
        		}else{
        			alert(data.msg);
        			return;
        		}
    ...
    //发布案例
    function addWorks(){
    	window.location.href="${base}/pc/org/case/case!toAdd.action";
    }
    //读取cat
    function editWorks(cid) {    
    	window.location.href="${base}/pc/org/case/case!edit.action?id="+cid
    }
</script>