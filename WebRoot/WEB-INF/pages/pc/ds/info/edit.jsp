  ...
  <s:property value="list"/>
        ...
        <div class="content_width" id="content">
            <div class="content_width ">
				    ...
				    <div class="menu_list menu_list_last">
				       ...
				       <ul>
                           <li >
                            ...
                            <li>
                                <a href="pc/ds/demand/demand!list.action?state=3" target="_parent">我的接单申请</a>
                            </li>
                            --><li>
                ...
                <div class="content peson_product_manage">
                    ...
                    <div class="picts">
                        <form id="inputForm" action="pc/ds/info/info!save.action" method="post" enctype="multipart/form-data" novalidate="novalidate">
		...
		<table class="input tabContent" style="display: table;">
			...
			<tr>
				...
				<td>
					<input type="text" name="entity.browseCount" class="text" readonly="readonly" value="<s:property value="entity.browseCount"/>">
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="entity.fansCount" class="text" readonly="readonly"  value="<s:property value="entity.fansCount"/>">
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="entity.followCount" class="text" readonly="readonly" value="<s:property value="entity.followCount"/>">
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="entity.demandCount" class="text" readonly="readonly" value="<s:property value="entity.demandCount"/>">
				</td>
			</tr>
			<tr>
				<th>
