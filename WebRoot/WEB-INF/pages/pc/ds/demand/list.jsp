...
<html>
  <head>
    <base href="<%=basePath%>">
        ...
        <title><s:if test="state==1">收到的派单</s:if> - 百爪鱼</title>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
	        ...
	        $(function(){
	        	...
	        	$("#quedingjujue").on("click",function(){
	        	
	        		window.location.href="<%=basePath%>pc/ds/demand/demand!save.action?id="+$("#recordId").val()+"&reason="+$("#reason").val()+"&state=4";
    ...
    <body>
		<div style="width:350px;height:80px;display: none;margin:0 auto;text-align: center" id="reasonDiv">
			...
			<div style="margin:0 auto;text-align: center;margin-top:10px;width:60%">
				<div  style="float:left;width:50%;padding-top:20px;">
					<input type="button" class="button" value="确定" id="quedingjujue">
				</div>
				<div  style="float:right;width:50%;padding-top:20px;">
					<input type="button" class="button" value="取消" id="close">
				</div>
                            ...
                            <span id="userName" class="name">
                                ...
                                <div class="caozuo" id="caozuo" style="display:none;" onmouseover="$('bg').rel=2;" onmouseout="$('bg').rel=1;">
                                    ...
                                    <ul class="cz " id="cz">
                                        ...
                                        <li>
                                            <a href="pc/ds/case/case!list.action" >我的案例</a>
                                        </li>
                                        <li>
        ...
        <div class="content_width" id="content">
            <div class="content_width ">
                ...
                <div class="menu_bar">
				    <div class="menu_list menu_list_last">
				        ...
				        <ul>
                            ...
                            <li>
                                <a href="pc/ds/apply/apply!list.action" target="_parent">我的接单申请</a>
                            </li>
                            --><li>
                                <a href="pc/ds/demand/demand!list.action?state=1" target="_parent">我收到的派单</a>
                            </li>
                            <li>
                                <a href="pc/ds/demand/demand!list.action?state=4" target="_parent">我的签单项目</a>
                            </li>
                        </ul>
				    ...
				    <div class="menu_list">
				        ...
				        <ul>
				            <li>
				                <a href="pc/ds/case/case!list.action" target="_parent">我的案例</a>
				            </li>
				        </ul>
				        <div class="string_1"></div>
				    </div>
				    <div class="menu_list">
				        ...
				        <ul>
				            <li >
				                <a href="pc/ds/info/info!edit.action" target="_parent">个人资料</a>
				            </li>
				            <li>
				                <a href="pc/ds/info/info!toChangePwd.action">帐号设置</a>
				            </li>
				        </ul>
				    </div>
				    <p class="clear"></p>
                ...
                <div class="content peson_product_manage">
                    <div class="tal">
                        <label><s:if test="state==2">收到的派单</s:if><s:if test="state==4">签单项目</s:if></label>
                    ...
                    <div class="picts">
                      ...
                      <!--  --> 
      <div class="path">
		<!-- <a href="web/common/main.action">首页</a> » --> <s:if test="state==1">收到的派单</s:if><s:if test="state==4">我的签单项目</s:if>  <span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="web/designDemand/designDemand!list.action" method="post">                 
			...
			<tbody><tr>
				...
				<th>
					<span><s:if test="state==1">操作</s:if><s:if test="state==4"><font color="red">进度</font></s:if></span>
				</th>
			</tr>
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<s:if test="state==1">
							<a href="pc/ds/demand/demand!save.action?id=<s:property value="id"/>&state=1">[同意]</a>
							<!-- href="pc/ds/demand/demand!save.action?id=<s:property value="id"/>&state=2"  -->
							<a onclick="jujue('<s:property value="id"/>')">[拒绝]</a>
						</s:if>
						<s:if test="state==2">
							<font color="red">设计中</font>
						</s:if>
						<s:if test="state==3">
...
<script type="text/javascript">
    ...
    //发布案例
    function addWorks(){
    	window.location.href="pc/ds/case/case!toAdd.action";
    }
    //读取cat
