            ...
            <div class="content_width ">
                ...
                <div class="menu_bar">
				    <div class="menu_list menu_list_last">
				        ...
				        <ul>
                            ...
                            <!--<li>
                                <a href="pc/ds/apply/apply!list.action" target="_parent">我的签单项目</a>
                            </li>
                            --><li>
                ...
                <div class="content peson_product_manage">
                    ...
                    <div class="picts">
                      ...
                      <!--  --> 
      <div class="path">
		<!-- <a href="web/common/main.action">首页</a> » --> 我的签单项目<span>(共<span id="pageTotal"><s:property value="#request.pager.pageCount" /></span>条记录)</span>
	</div>
	<form id="listForm" action="pc/ds/apply/apply!list.action" method="post">                 
			...
			<s:iterator value="list" status="statu" >   
				<tr>
					...
					<td>
						<s:if test="0==designDemand.state and designDemand.effective==0">申请中</s:if>
						<s:if test="0==designDemand.state and designDemand.effective==1">已被拒</s:if>
					</td>
				</tr>
				</s:iterator>
		</tbody></table>
