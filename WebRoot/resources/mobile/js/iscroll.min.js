(function(h, w) {
    ...
    x.prototype = {
        ...
        _move: function(b) {
            ...
            if (this.options.zoom && n && 1 < b.touches.length) e = f.abs(b.touches[0].pageX - b.touches[1].pageX),
        ...
        _end: function(b) {
            if (!n || 0 === b.touches.length) {
                ...
                if (a.zoomed) m = a.scale * a.lastScale,
                ...
                a.options.onZoomEnd && a.options.onZoomEnd.call(a, b);
                    ...
                    if (a.moved) {
                        if (300 > u && a.options.momentum) {
                            ...
                            m = a.x + g.dist;
                            k = a.y + l.dist;
                            if (0 < a.x && 0 < m || a.x < a.maxScrollX && m < a.maxScrollX) g = {
                                dist: 0,
                                time: 0
                            };
        ...
        _resetPos: function(b) {
            ...
            a == this.x && c == this.y ? (this.moved && (this.moved = !1, this.options.onScrollEnd && this.options.onScrollEnd.call(this)), this.hScrollbar && this.options.hideScrollbar && ("webkit" == p && (this.hScrollbarWrapper.style[C] = "300ms"), this.hScrollbarWrapper.style.opacity = "0"), this.vScrollbar && this.options.hideScrollbar && ("webkit" == p && (this.vScrollbarWrapper.style[C] = "300ms"), this.vScrollbarWrapper.style.opacity = "0")) : this.scrollTo(a, c, b || 0)
        },
        _wheel: function(b) {
            var a = this,
            c, d;
            if ("wheelDeltaX" in b) c = b.wheelDeltaX / 12,
            d = b.wheelDeltaY / 12;
            ...
            "zoom" == a.options.wheelAction ? (d = a.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < a.options.zoomMin && (d = a.options.zoomMin), d > a.options.zoomMax && (d = a.options.zoomMax), d != a.scale && (!a.wheelZoomCount && a.options.onZoomStart && a.options.onZoomStart.call(a, b), a.wheelZoomCount++, a.zoom(b.pageX, b.pageY, d, 400), setTimeout(function() {
                a.wheelZoomCount--; ! a.wheelZoomCount && a.options.onZoomEnd && a.options.onZoomEnd.call(a, b)
            },
        ...
        _startAni: function() {
            ...
            b.animating || (b.steps.length ? (e = b.steps.shift(), e.x == a && e.y == c && (e.time = 0), b.animating = !0, b.moved = !0, b.options.useTransition ? (b._transitionTime(e.time), b._pos(e.x, e.y), b.animating = !1, e.time ? b._bind(v) : b._resetPos(0)) : (h = function() {
                var k = Date.now(),
                m;
                k >= d + e.time ? (b._pos(e.x, e.y), b.animating = !1, b.options.onAnimationEnd && b.options.onAnimationEnd.call(b), b._startAni()) : (k = (k - d) / e.time - 1, g = f.sqrt(1 - k * k), k = (e.x - a) * g + a, m = (e.y - c) * g + c, b._pos(k, m), b.animating && (b.aniTime = O(h)))
            },
            h())) : b._resetPos(400))
        },
        ...
        _offset: function(b) {
            ...
            c = -b.offsetTop; b = b.offsetParent;) a -= b.offsetLeft,
            c -= b.offsetTop;
        ...
        _bind: function(b, a, c) { (a || this.scroller).addEventListener(b, this, !!c)
        },
        _unbind: function(b, a, c) { (a || this.scroller).removeEventListener(b, this, !!c)
        },
        destroy: function() {
        ...
        refresh: function() {
            ...
            if ("string" == typeof this.options.snap) for (this.pagesX = [], this.pagesY = [], c = this.scroller.querySelectorAll(this.options.snap), b = 0, a = c.length; b < a; b++) d = this._offset(c[b]),
            ...
            this.pagesY[b] = d.top < this.maxScrollY ? this.maxScrollY: d.top * this.scale;
                ...
                for (this.pagesX = []; d >= this.maxScrollX;) this.pagesX[a] = d,
                d -= this.wrapperW,
                a++;
                ...
                a = d = 0;
                for (this.pagesY = []; d >= this.maxScrollY;) this.pagesY[a] = d,
                d -= this.wrapperH,
                a++;
        ...
        scrollTo: function(b, a, c, d) {
            ...
            b = 0;
            for (a = e.length; b < a; b++) e[b].relative && (e[b].x = this.x - e[b].x, e[b].y = this.y - e[b].y),
            this.steps.push({
                x: e[b].x,
                y: e[b].y,
                time: e[b].time || 0
        ...
        scrollToElement: function(b, a) {
            var c;
            if (b = b.nodeType ? b: this.scroller.querySelector(b)) c = this._offset(b),
